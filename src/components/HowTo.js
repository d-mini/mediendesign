...
function HowTo() {
    return (
        <div className='howto w-full'>
            <div className='w-full py-20 px-12 sm:py-16 sm:px-36 flex flex-col gap-8 sm:flex-row'>
            ...
            <div className='w-full flex flex-col gap-8 pt-0 pb-20 px-12 sm:pb-16 sm:px-36'>
                <div>
